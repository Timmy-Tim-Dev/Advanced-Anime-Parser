...
if ( $action == "update" ) {
	...
	if( $upgrade_version !== '' && file_exists( ENGINE_DIR . "/mrdeath/aaparser/includes/upgrade/".$upgrade_version.".php" ) ) include ( ENGINE_DIR . "/mrdeath/aaparser/includes/upgrade/".$upgrade_version.".php" );
