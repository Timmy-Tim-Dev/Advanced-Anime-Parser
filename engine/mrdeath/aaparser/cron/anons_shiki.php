...
if ( $shikimori ) {
    ...
    if ($xfields_data['shikimori_kind'] == "ona") {
		$xfields_data['shikimori_kind'] = "ONA";
	} elseif ($xfields_data['shikimori_kind'] == "ova") {
		$xfields_data['shikimori_kind'] = "OVA";
	} elseif ($xfields_data['shikimori_kind'] == "movie") {
		$xfields_data['shikimori_kind'] = "Фильм";
	} elseif ($xfields_data['shikimori_kind'] == "tv") {
		$xfields_data['shikimori_kind'] = "ТВ-сериал";
	} elseif ($xfields_data['shikimori_kind'] == "special") {
		$xfields_data['shikimori_kind'] = "Спэшл";
	} else {
		$tags_array[] = $xfields_data['kodik_status_ru'];
	}
...
*/	
	...
	if ($xfields_data['shikimori_russian']) {
		$title = $xfields_data['shikimori_russian'];
	} elseif ($xfields_data['shikimori_name']) {
		$title = $xfields_data['shikimori_name'];
	} elseif ($xfields_data['shikimori_english']){
		$title = $xfields_data['shikimori_english'];
	} elseif ($xfields_data['shikimori_japanese']){
		$title = $xfields_data['shikimori_japanese'];
	} elseif ($xfields_data['shikimori_synonyms']){
		$title = $xfields_data['shikimori_synonyms'];
	}
	$alt_name = totranslit($title);
	$alt_name = str_replace(".", "", $alt_name);
	$alt_name = str_replace(",", "", $alt_name);
	// $title = check_if($aaparser_config['xfields']['title'], $xfields_data);
	// $title = check_if($aaparser_config['xfields']['title'], $xfields_list);
	
	// $title = preg_replace("#\{.*?\}|\[if.*?\].*?\[\/if.*?\]#uis", "", $title);
