...
showRow('Дополнительное поле c плеером', 'Выберите дополнительное поле в котором содержится ссылка на плеер с балансера', makeDropDown( $xfields_list, "updates[xf_player]", $aaparser_config['updates']['xf_player']));
...
showRow('Дополнительное поле c последним вышедшим сезоном (обязательно)', 'Выберите дополнительное поле c последним вышедшим сезоном сериала (целое число)', makeDropDown( $xfields_list, "updates[xf_season]", $aaparser_config['updates']['xf_season']));
showRow('Дополнительное поле c последней вышедшей серией (обязательно)', 'Выберите дополнительное поле c последней вышедшей серией сериала (целое число)', makeDropDown( $xfields_list, "updates[xf_series]", $aaparser_config['updates']['xf_series']));
...
showRow('Дополнительное поле cо статусом сериала на английском', 'Выберите дополнительное поле cо статусом сериалов на английском', makeDropDown( $xfields_list, "updates[xf_status]", $aaparser_config['updates']['xf_status']));
showRow('Дополнительное поле cо статусом сериала на русском', 'Выберите дополнительное поле cо статусом сериалов на русском', makeDropDown( $xfields_list, "updates[xf_status_ru]", $aaparser_config['updates']['xf_status_ru']));
...
showRow('Дополнительное поле c качеством фильма', 'Выберите дополнительное поле c качеством фильма', makeDropDown( $xfields_list, "updates[xf_quality]", $aaparser_config['updates']['xf_quality']));
...
showRow('Дополнительное поле cо всеми доступными озвучками', 'Выберите дополнительное поле cо всеми доступными озвучками', makeDropDown( $xfields_list, "updates[xf_translation]", $aaparser_config['updates']['xf_translation']));
...
showRow('Дополнительное поле c последней добавленной озвучкой', 'Выберите дополнительное поле в котором содержиться озвучка последней добавленной в базу серии', makeDropDown( $xfields_list, "updates[xf_translation_last]", $aaparser_config['updates']['xf_translation_last']));
