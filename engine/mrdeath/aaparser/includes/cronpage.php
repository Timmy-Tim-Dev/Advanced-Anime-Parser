			...
			<table class="table table-striped">
				<tbody>
					<tr>
						...
						<p><b>Каждый час в 11, 21, 31, 41, 51 минуты</b> - Происходит Добавление Анонсов</p>
			...
			<table class="table table-striped">
				<tbody>
					...
					<tr>
						...
						<p>Если необходимо проверять обновление новостей, выход новой серии, поднятие при выходе новой серии т.д. То это то что Вам нужно.</p>
					...
					<tr>
						...
						<p>Крон проверяет наличие расхождений по базе данных у первоисточника. Если у первоисточника новые данные, то крон выполнит корректно задачу.<br>
						P.S. Крон проверяет не те категории которые указаны в новостях. Проверяет по таблице anime_list в базе данных. Поэтому не рекомендую тестить его ручным образом. Данный крон не поднимает новость при обновлении.</p>
					...
					<tr>
						...
						<b>Желательно ставить раз в миниту.</b>
						<b>Крон не работает пока Вы его не включите в настройках.</b>
						<p>Крон проверяет наличие расхождений по базе данных у первоисточника. Данный крон не поднимает новость при обновлении.</p>
					...
					<tr>
						...
						<b>Желательно ставить с интервалом 1 или 2 раза в минуту.</b><br/>
