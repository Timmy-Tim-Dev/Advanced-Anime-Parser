...
} elseif ( $aaparser_config['push_notifications']['enable_tgposting'] == 1 ) require_once (DLEPlugins::Check(ENGINE_DIR . '/mrdeath/aaparser/telegram_sender/telegramsend.php'));