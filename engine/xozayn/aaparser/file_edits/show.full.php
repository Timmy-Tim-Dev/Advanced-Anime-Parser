...
if ( isset($aaparser_config['player']['player_method']) && $aaparser_config['player']['player_method'] == 1 ) {
    ...
    if ( $aaparser_config['player']['method'] == 1 ) include (DLEPlugins::Check(ENGINE_DIR.'/xozayn/aaparser/ajax/playlist_new.php'));
    elseif ( $aaparser_config['player']['method'] == 2 ) include (DLEPlugins::Check(ENGINE_DIR.'/xozayn/aaparser/ajax/playlist_screen.php'));
    else include (DLEPlugins::Check(ENGINE_DIR.'/xozayn/aaparser/ajax/playlist.php'));
} else {
...
if ( isset($aaparser_config['persons']['personas_on_dorama']) && $aaparser_config['persons']['personas_on_dorama'] == 1 && isset($aaparser_config['main_fields']['xf_mdl_id']) && isset($xfieldsdata[$aaparser_config['main_fields']['xf_mdl_id']]) && $xfieldsdata[$aaparser_config['main_fields']['xf_mdl_id']] ) {
    ...
    include (DLEPlugins::Check(ENGINE_DIR.'/xozayn/aaparser/ajax/persons.php'));
