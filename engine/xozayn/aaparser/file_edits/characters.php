...
if ($type == "persons") {
	...
	if (isset($aaparser_config['persons']['persons_dorama_sitemap']) && $aaparser_config['persons']['persons_dorama_sitemap']) { 
		...
		$data = unserialize(file_get_contents(ENGINE_DIR."/xozayn/aaparser/data/persons.dat"));
		...
		if (!in_array($sitemapurl, $urls) && $sitemapurl != '') {
			...
			$data = serialize($data);
			file_put_contents(ENGINE_DIR."/xozayn/aaparser/data/persons.dat", $data);
			chmod( ENGINE_DIR . "/xozayn/aaparser/data/persons.dat", 0777 );
		}
	}
}
...
if ($type == "people") {
	...
	if (isset($aaparser_config['persons']['persons_sitemap']) && $aaparser_config['persons']['persons_sitemap']) { 
		...
		$data = unserialize(file_get_contents(ENGINE_DIR."/xozayn/aaparser/data/people.dat"));
		if (!is_array($data)) $data = array();
		$urls = array_column($data, 'url');
		if (!in_array($sitemapurl, $urls) && $sitemapurl != '') {
			$data[] = array(
			...
			$data = serialize($data);
			file_put_contents(ENGINE_DIR."/xozayn/aaparser/data/people.dat", $data);
			chmod( ENGINE_DIR . "/xozayn/aaparser/data/people.dat", 0777 );
		}
	}
}
if ($type == "characters") {
	...
	if (isset($aaparser_config['persons']['persons_sitemap']) && $aaparser_config['persons']['persons_sitemap']) { 
		$sitemapurl = ltrim($json['url'], '/');
		$data = unserialize(file_get_contents(ENGINE_DIR."/xozayn/aaparser/data/characters.dat"));
		if (!is_array($data)) $data = array();
		$urls = array_column($data, 'url');
		if (!in_array($sitemapurl, $urls) && $sitemapurl != '') {
			$data[] = array(
			...
			$data = serialize($data);
			file_put_contents(ENGINE_DIR."/xozayn/aaparser/data/characters.dat", $data);
			chmod( ENGINE_DIR . "/xozayn/aaparser/data/characters.dat", 0777 );
		}
	}
