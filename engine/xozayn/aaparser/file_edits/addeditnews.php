                ...
                success: function(data) {
					if ( data.status == "results" ) {
                        ...
                        $.each(data.result, function(key, item) {
							...
							if ( item.kodik_exists ) results += "<td><span class=\"pntr\" data-balloon-length=\"medium\" aria-label=\"Есть в базе Kodik\" data-balloon-pos=\"up\"><b><img src=\"/uploads/kodik_logo.png\"></b></span></td>";
							else results += "<td> </td>";
							if (item.find_id == 'est') {
