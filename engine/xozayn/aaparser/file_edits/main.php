...
$('#isPublic').on('click', function() {
    ...
    $.get(dle_root + "index.php?controller=ajax&mod=message_room", { room_status: room_status, room_id: room_id, action: 'room_status', user_hash: dle_login_hash }, function(data){
		if ( data.status == "ok" ) {
...
function sendRoomMessage() {
    ...
    $.get(dle_root + "index.php?controller=ajax&mod=message_room", { message: textArea.val(), room_id: room_id, action: 'send', user_hash: dle_login_hash }, function(data){
...
function getRoomUpdates() {
    ...
    findIframe();
    $.get(dle_root + "index.php?controller=ajax&mod=message_room", { room_leader: room_leader, room_id: room_id, action: 'check', user_hash: dle_login_hash }, function(data){
...
function kodikMessageListener(message) {
    ...
    if ( room_leader == '{$member_id['name']}' ) {
    	if (message.data.key == 'kodik_player_time_update') {
    		...
    		$.get(dle_root + "index.php?controller=ajax&mod=message_room", { room_id: room_id, action: 'update_time', time: message.data.value, user_hash: dle_login_hash }, function(data){
				if ( data.status == "updated" ) {
      		...
      		$.get(dle_root + "index.php?controller=ajax&mod=message_room", { room_id: room_id, action: 'set_play', user_hash: dle_login_hash }, function(data){
				if ( data.status == "play" ) {
      		...
      		$.get(dle_root + "index.php?controller=ajax&mod=message_room", { room_id: room_id, action: 'set_pause', user_hash: dle_login_hash }, function(data){
      		...
      		$.get(dle_root + "index.php?controller=ajax&mod=message_room", { room_id: room_id, action: 'set_speed', speed: message.data.value.speed, user_hash: dle_login_hash }, function(data){
				if ( data.speed ) {
      		...
      		$.get(dle_root + "index.php?controller=ajax&mod=message_room", { room_id: room_id, action: 'set_episode', episode: message.data.value, shikimori_id: shikimori_id, mdl_id: mdl_id, user_hash: dle_login_hash }, function(data){
