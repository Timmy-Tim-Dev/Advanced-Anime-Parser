...
if ( $action == "update" ) {
	...
	file_put_contents( ENGINE_DIR .'/xozayn/aaparser/data/kodik.log', "");
	file_put_contents( ENGINE_DIR .'/xozayn/aaparser/data/shikimori.log', "");
    ...
    if ( file_exists(ENGINE_DIR.'/xozayn/aaparser/data/translators_name.json') ) {
        ...
        $fp = fopen(ENGINE_DIR.'/xozayn/aaparser/data/translators_name.json', "w+");
    ...
    if ( file_exists(ENGINE_DIR.'/xozayn/aaparser/data/translators.json') ) {
        ...
        $fp2 = fopen(ENGINE_DIR.'/xozayn/aaparser/data/translators.json', "w+");
    ...
    if ( file_exists(ENGINE_DIR.'/xozayn/aaparser/data/translators_name_dorama.json') ) {
        ...
        $fp = fopen(ENGINE_DIR.'/xozayn/aaparser/data/translators_name_dorama.json', "w+");
  	    fwrite($fp, json_encode($translators_name, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES ));
  	    fclose($fp);
    }
    ...
    if ( file_exists(ENGINE_DIR.'/xozayn/aaparser/data/translators_dorama.json') ) {
        ...
        $fp2 = fopen(ENGINE_DIR.'/xozayn/aaparser/data/translators_dorama.json', "w+");
  	    fwrite($fp2, json_encode($translators, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES ));
  	    fclose($fp2);
    }
    ...
    if ( file_exists(ENGINE_DIR.'/xozayn/aaparser/data/countries_name.json') ) {
        ...
        $fp = fopen(ENGINE_DIR.'/xozayn/aaparser/data/countries_name.json', "w+");
