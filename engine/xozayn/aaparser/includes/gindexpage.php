...
HTML;
if ($php_version >= 74 && file_exists(ENGINE_DIR.'/xozayn/aaparser/google_indexing/indexing.php')) {
		...
		echo <<<HTML
			<tr>
				<td class="col-xs-10 col-sm-6 col-md-10 ">
					...
					<span class="note large">Скачать файлы по ссылке и закинуть в папку "{$config['http_home_url']}xozayn/aaparser/" содержимое Архива GOOGLE INDEXING</span>
				</td>
