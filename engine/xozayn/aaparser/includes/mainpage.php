...
showRow('Домен Shikimori для запросов к api', 'По умолчанию <b>//shikimori.me/</b>, замените в случае переезда/замены домена Shikimori для запросов к api. В начале и со слешем в конце', showInput(['settings[shikimori_api_domain]', 'text', $aaparser_config['settings']['shikimori_api_domain']]));
