...
showRow('Количество новостей, проверяемых за один раз', 'Введите количество новостей, которые модуль будет проверять за один раз. Рекомендуемое значение 50. Если у вас слабый сервер или шаред хостинг и при обновлении кроном вы видите ошибку mysql "MySQL server has gone away", тогда уменьшите количество новостей до 10-20<br/><b class="faq_find faq_id_4">Подробнее</b>', showInput(['updates[max_check]', 'number', $aaparser_config['updates']['max_check']]));
