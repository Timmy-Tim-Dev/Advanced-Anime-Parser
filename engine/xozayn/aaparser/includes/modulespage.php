...
HTML;
include_once (DLEPlugins::Check(ENGINE_DIR.'/xozayn/aaparser/includes/playerpage.php')); //Вывод плеера
include_once (DLEPlugins::Check(ENGINE_DIR.'/xozayn/aaparser/includes/calendar.php')); //Расписание серий
include_once (DLEPlugins::Check(ENGINE_DIR.'/xozayn/aaparser/includes/updates_block_page.php')); //Блок обновления сериалов
include_once (DLEPlugins::Check(ENGINE_DIR.'/xozayn/aaparser/includes/pushpage.php')); //Push уведомления
include_once (DLEPlugins::Check(ENGINE_DIR.'/xozayn/aaparser/includes/roomspage.php')); //Совместный просмотр
include_once (DLEPlugins::Check(ENGINE_DIR.'/xozayn/aaparser/includes/gindexpage.php')); //Google indexing
include_once (DLEPlugins::Check(ENGINE_DIR.'/xozayn/aaparser/includes/tgpostingpage.php')); //Постинг в Telegram
include_once (DLEPlugins::Check(ENGINE_DIR.'/xozayn/aaparser/includes/personajespage.php')); //Актёры и персонажи
include_once (DLEPlugins::Check(ENGINE_DIR.'/xozayn/aaparser/includes/debugerpage.php')); //Дебагинг
echo <<<HTML
</div>
HTML;
?>