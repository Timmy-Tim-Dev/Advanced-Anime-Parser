...
showRow( 'Начать с определенной новости', 'Начинает с указанного ID новости, если нужно с начала, то просто укажите 0.', showInput(['news-start-update', 'text', "0"]), "", "" );
...
showRow( 'Начать с определенной новости', 'Начинает с указанного ID новости, если нужно с начала, то просто укажите 0.', showInput(['news-metas-start-update', 'text', "0"]), "", "" );
...
echo <<<HTML
			...
			<tr>
				...
				<textarea style="width:100%;height:50px;" disabled="">{$config['http_home_url']}index.php?controller=ajax&mod=anime_grabber&module=aaparser_clear&action=update_xfields</textarea>
				</td>
			</tr>
			<tr>
				<td>
				...
				<b>Желательно ставить раз в две недели.</b>
				<textarea style="width:100%;height:50px;" disabled="">{$config['http_home_url']}index.php?controller=ajax&mod=anime_grabber&module=aaparser_clear&action=update_cats</textarea>
				</td>
			</tr>
			</table>
		</div>
