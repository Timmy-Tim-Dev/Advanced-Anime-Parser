...
echo <<<HTML
				...
				<div class="panel-body" style="padding: 20px;font-size:20px; font-weight:bold;">Массовое проставление скриншотов</div>
		<div class="table-responsive">
			<table class="table table-striped">
HTML;
...
echo <<<HTML
			...
			<div class="update-status">
	            <div class="update-status__current" id="updated-current-screens">0%</div>
	            <div class="progress progress-success">
		            <div class="bar" id="updated-bar-screens" style="width: 0%;"></div>
	            </div>
	            <div class="update-status__msg" id="result-msg-update-screens">Запустите проставление...После запуска не закрывайте данную страницу пока проставление не будет полностью готово!</div>
            </div>
		</div>
	</div>
HTML;
