		...
		<div class="table-responsive">
			<table class="table table-striped">
				<tbody>
					<tr>
						<td>
							<b style="color:red">Внимание!</b> Инструкция по добавлению ссылок в планировщик задач. Существует три способа:
							<br><br>
							<p>1. /usr/bin/wget -O /dev/null -q "Ваша cron-ссылка"</p>
							<p>2. wget -O /dev/null "Ваша cron-ссылка"</p>
							<p>3. Обратитесь в техническую поддержку для добавления cron-ссылок в соответствии с описанием, или попросите помощи у ChatGPT.</p>
						</td>
					</tr>
					<tr>
						<td>
							...
							<textarea style="width:100%;height:50px;" disabled="">{$config['http_home_url']}index.php?controller=ajax&mod=anime_grabber&key={$cron_key}</textarea>
			...
			<table class="table table-striped">
				<tbody>
					...
					<tr>
						...
						<textarea style="width:100%;height:50px;" disabled="">{$config['http_home_url']}index.php?controller=ajax&mod=anime_grabber&action=grabbing&key={$cron_key}</textarea>
						</td>
					</tr>
					<tr>
						<td>
						...
						<textarea style="width:100%;height:50px;" disabled="">{$config['http_home_url']}index.php?controller=ajax&mod=anime_grabber&action=update&key={$cron_key}</textarea>
						</td>
					</tr>
					<tr>
						<td>
						...
						<textarea style="width:100%;height:50px;" disabled="">{$config['http_home_url']}index.php?controller=ajax&mod=anime_grabber&action=category_updating&key={$cron_key}</textarea>
						</td>
					</tr>
					<tr>
						<td>
						...
						<textarea style="width:100%;height:50px;" disabled="">{$config['http_home_url']}index.php?controller=ajax&mod=anime_grabber&action=xfields_updating&key={$cron_key}</textarea>
						</td>
					</tr>
					<tr>
						<td>
						...
						<textarea style="width:100%;height:50px;" disabled="">{$config['http_home_url']}index.php?controller=ajax&mod=anime_grabber&action=add&key={$cron_key}</textarea>
						</td>
					</tr>
					<tr>
						<td>
						...
						<textarea style="width:100%;height:50px;" disabled="">{$config['http_home_url']}index.php?controller=ajax&mod=anime_grabber&action=other&key={$cron_key}</textarea>
						</td>
					</tr>
					<tr class="anime-settings">
						...
						<textarea style="width:100%;height:50px;" disabled="">{$config['http_home_url']}index.php?controller=ajax&mod=anime_grabber&action=anons_shiki&key={$cron_key}</textarea>
						</td>
					</tr>
				</tbody>
			</table>
