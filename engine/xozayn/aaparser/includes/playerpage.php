...
$playlist_cache_size = convert_bytes(dir_size(ENGINE_DIR."/xozayn/aaparser/cache/player/"));
...
showRow('Метод вывода плейлиста', 'Выберите метод вывода плейлиста.<br>AJAX - загрузка плейлиста срабатывает по ajax при каждом входе на страницу.<br>Статичный - при условии наличия кеша плейлиста он будет обработан и показан сразу на странице полной новости, если же кеш отсуствует то прогрузка будет с помощью ajax. <span style="color:red">Обязательно замените старую строчку вывода плейлиста в fullstory.tpl с <b>&lt;div id="kodik_player_ajax" data-news_id="{news-id}"&gt;&lt;/div&gt;</b> на <b>{kodik_playlist}</b></span>', makeDropDown( array(0 => 'AJAX', 1 => 'статичный'), "player[player_method]", $aaparser_config['player']['player_method']));
