...
echo <<<HTML
					...
					<tr>
						...
						<textarea style="width:100%;height:50px;" disabled="">{$config['http_home_url']}index.php?controller=ajax&mod=anime_grabber&action=anons_clean&key={$cron_key}</textarea>
						</td>
					</tr>
				</tbody>
			</table>
